...
export default function Header() {
  // ... övriga states och funktioner
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [showMenu, setShowMenu] = useState(false);
  const [isDropdownOpen, setIsDropdownOpen] = useState(false);
  const dropdownTimeoutRef = useRef(null);
  // Ny state för att spåra vilken dropdown-länk som är hovered
  ...
  // Hantera musens in- och utgående för dropdownen
        ...
        <div id="header-container" className="relative mx-auto max-w-7xl px-4 py-2">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center justify-center space-x-6">
              ...
              {/* Dropdown-förälder: "relative" men ingen pt-2 som kan flytta texten */}
              <div
              ...
              >
                ...
                {/* Dropdownen (absolut positionerad) */}
                {isDropdownOpen && (
                  <div
                    className="
                      absolute
