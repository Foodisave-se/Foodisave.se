    ...
    <div className="w-full">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center bg-[#c8c8c8]">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <button
            ...
            className="mt-8 bg-black text-white py-2 px-6 rounded-md shadow-lg hover:bg-[#888383] transition-all duration-300 text-lg cursor-pointer"
          >
            Läs mer
          </button>
        </div>
      ...
      <section id="readmore" className="bg-[#c8c8c8] py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto px-4 mt-8">
          {/* Kort 1 */}
          <div className="relative bg-white rounded-md shadow-lg p-6 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
            <img
              src={ingredients}
          ...
          {/* Kort 2 */}
          <div className="bg-white rounded-md shadow-lg p-6 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
            <img
              src={plate}
              alt="Recept via Maträtt"
              className="mx-auto mb-4 w-10 h-10"
            />
        ...
        <div className="flex items-center justify-center mt-4">
          <Link to="/register">
            <button className="mt-8 bg-orange-500 py-2 px-6 rounded-md shadow-lg hover:bg-orange-700 transition-all duration-300 text-lg cursor-pointer">
              Prova Gratis
            </button>
          </Link>
        </div>
      ...
      <section className="min-h-110 bg-white">
        <div className="text-center mx-auto">
          ...
          <p className="text-gray-900 text-m text-center sm:text-l md:text-xl mt-2">
            När man blir medlem så startar man med 100 credits. <br/> Alla Ai-funktioner kommer dra av en bestämd mängd credits från ditt konto varje gång de används.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 items-center pt-6 gap-8 max-w-7xl mx-auto px-4 pb-10">
          ...
          <div className="max-h-126">
            ...
            <ul>
              <li className="bg-[#c8c8c8] py-2 rounded-md pl-2 shadow-md">
                <div className="flex items-center">
                  <img src={plusUser} alt="Ny Medlem" className="w-6 h-6" />
                  <p className="pl-2">Ny Medlem: +100 Credits</p>
                </div>
              </li>
              <li className="bg-[#c8c8c8] mt-2 py-2 rounded-md pl-2 shadow-md">
                <div className="flex items-center">
                  <img src={heart} alt="Sparat Recept" className="w-6 h-6" />
                  <p className="pl-2">Sparat Recept: +2 Credits/Dag</p>
                </div>
              </li>
              <li className="bg-[#c8c8c8] my-2 py-2 rounded-md pl-2 shadow-md">
                <div className="flex items-center">
                  <img src={user} alt="Inloggning" className="w-6 h-6" />
                  <p className="pl-2">Inloggning: +2 Credits/Dag</p>
                </div>
              </li>
              <li className="bg-[#c8c8c8] py-2 rounded-md pl-2 shadow-md">
                <div className="flex items-center">
                  <img src={empty} alt="Slut på Credits" className="w-6 h-6" />
